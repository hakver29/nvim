...
local config = {
  ...
  settings = {
    java = {
      ...
      home = "/Users/hakonveras/Library/Java/JavaVirtualMachines/openjdk-24.0.1/Contents/Home/",
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-17",
            path = "/Users/hakonveras/Library/Java/JavaVirtualMachines/temurin-17.0.9/Contents/Home/",
          },
          {
            name = "JavaSE-21",
            path = "/Users/hakonveras/Library/Java/JavaVirtualMachines/temurin-21.0.4/Contents/Home/",
          },
          {
            name = "JavaSE-24",
            path = "/Users/hakonveras/Library/Java/JavaVirtualMachines/openjdk-24.0.1/Contents/Home/",
          },
        },
      },
      maven = {
